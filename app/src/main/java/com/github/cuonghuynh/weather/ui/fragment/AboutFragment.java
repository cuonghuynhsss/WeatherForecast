...
import com.github.cuonghuynh.weather.ui.activity.MainActivity;
import com.github.cuonghuynh.weather.utils.AppUtil;
import com.github.cuonghuynh.weather.utils.LocaleManager;
import com.github.cuonghuynh.weather.utils.MyApplication;
import com.github.cuonghuynh.weather.utils.SharedPreferencesUtil;
...
public class AboutFragment extends DialogFragment {
  ...
  private void initVariables(View view) {
    ...
    if (activity != null) {
      ...
      setTextWithLinks(view.findViewById(R.id.text_application_info), getString(R.string.application_info_text));
      ...
      setTextWithLinks(view.findViewById(R.id.text_libraries),"  ");
      ...
      if (currentLanguage.equals(LocaleManager.LANGUAGE_ENGLISH)) {
        ...
        binding.vietnameseButton.setIcon(drawable);
      }
    }
    ...
    binding.englishButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        if (currentLanguage.equals(LocaleManager.LANGUAGE_VIETNAMESE)) {
          MyApplication.localeManager.setNewLocale(activity, LocaleManager.LANGUAGE_ENGLISH);
          restartActivity();
        }
      }
    });
    binding.vietnameseButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        if (currentLanguage.equals(LocaleManager.LANGUAGE_ENGLISH)) {
          MyApplication.localeManager.setNewLocale(activity, LocaleManager.LANGUAGE_VIETNAMESE);
          restartActivity();
        }
      }
    });
