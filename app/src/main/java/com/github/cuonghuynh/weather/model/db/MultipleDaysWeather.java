package com.github.cuonghuynh.weather.model.db;
...
import com.github.cuonghuynh.weather.databinding.MultipleDaysItemBinding;
import com.github.cuonghuynh.weather.utils.AppUtil;
import com.github.cuonghuynh.weather.utils.Constants;
import com.github.cuonghuynh.weather.utils.DateConverter;
    ...
    public void bindView(@NonNull MultipleDaysWeather item, @NonNull List<Object> payloads) {
      ...
      if (AppUtil.isRTL(context)) {
        ...
        binding.dateTextView.setText(String.format(Locale.getDefault(), "%d %s", converter.getIranianDay()
            , Constants.MONTH_NAME_VIET_NAM[converter.getIranianMonth() - 1]));
      } else {
